...
/**
 * The Class PrintPhone, a class which create a widget that show a file that you want to print of the phone.
 */
public class PrintPhone {
	...
	/** The title STR. */
	private final String titleSTR = "PRINT FROM PHONE"; //$NON-NLS-1$
