...
public class ScanDoc {
	...
	/** The title STR. */
	private final String titleSTR = "SCAN DOCUMENT"; //$NON-NLS-1$

	/** The text 1 STR. */
	private final String text1STR = "Please lift the lid and place the document"; //$NON-NLS-1$

	/** The text 2 STR. */
	private final String text2STR = "on the tray. Hit Scan when you're done."; //$NON-NLS-1$

	/** The Constant SCAN_BACKG. */
	private static final String SCAN_BACKG = "/images/BUTTON_SCAN.png"; //$NON-NLS-1$
	...
	public Widget getContentWidget() {
		...
		text1LBL = new Label(this.text1STR);
		...
		cv.addChild(text1LBL, 60, 50, Widget.NO_CONSTRAINT, Widget.NO_CONSTRAINT);
		cv.addChild(text2LBL, 70, 75, Widget.NO_CONSTRAINT, Widget.NO_CONSTRAINT);
